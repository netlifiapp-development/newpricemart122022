...
import 'allorders_model.dart';
export 'allorders_model.dart';
...
class _AllordersWidgetState extends State<AllordersWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllordersModel());
                                ...
                                Padding(
                                  ...
                                  child: StreamBuilder<List<UserCartRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final containerUserCartRecord =
                                          containerUserCartRecordList.isNotEmpty
                                              ? containerUserCartRecordList
                                                  .first
                                              : null;
                                      return Container(
