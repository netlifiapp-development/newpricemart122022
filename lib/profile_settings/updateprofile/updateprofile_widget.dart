...
class _UpdateprofileWidgetState extends State<UpdateprofileWidget> {
  ...
  void initState() {
    ...
    _model.yourSponsorController ??= TextEditingController();
        ...
        child: AppBar(
          ...
          title: Padding(
            ...
            child: Column(
              ...
              children: [
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 25.0, 0.0, 8.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
          ...
          children: [
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                validator:
                    _model.yourSponsorControllerValidator.asValidator(context),
              ),
            ),
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                maxLines: null,
                validator:
                    _model.cityAddressControllerValidator.asValidator(context),
              ),
            ),
            Align(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    final usersUpdateData = createUsersRecordData(
                      ...
                      sponsorID:
                          int.tryParse(_model.yourSponsorController.text),
